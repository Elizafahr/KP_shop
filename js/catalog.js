...
const products = [
  ...
  },
  {
    ...
    brand: "PULSE",
    description:
      "Классический скейтборд с прочной декой длиной 80 см и высококачественными подшипниками для плавного катания.",
  ...
  },
  {
    ...
    brand: "PULSE",
    description:
      "Скейтборд с компактной декой длиной 75 см, идеальный для начинающих райдеров.",
  ...
  },
  {
    ...
    costLast: 500,
    description:
      "Спортивный шейкер объемом 500 мл для приготовления протеиновых коктейлей и других напитков. Изготовлен из прочного пластика, имеет удобную форму для захвата руки и встроенное ситечко для лучшего перемешивания.",
  ...
  },
  {
    ...
    costLast: 600,
    description:
      "Спортивный шейкер объемом 700 мл для приготовления протеиновых коктейлей и других напитков. Изготовлен из прочного пластика, имеет удобную форму для захвата руки и встроенное ситечко для лучшего перемешивания.",
  ...
  },
  {
    ...
    costLast: 1500,
    description:
      "Стильные и прочные солнцезащитные очки специально разработанные для занятий спортом. Обеспечивают 100% защиту от ультрафиолетовых лучей, имеют ударопрочные линзы и регулируемые дужки для идеальной посадки.",
  ...
  },
  {
    ...
    costLast: 2200,
    description:
      "Высококачественные поляризационные солнцезащитные очки для спорта. Обеспечивают 100% защиту от ультрафиолетовых лучей и устраняют блики. Ударопрочные линзы и регулируемые дужки для максимального комфорта.",
